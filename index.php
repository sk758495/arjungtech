...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .logo-img {
                height: 120px;
                /* Slightly larger logo for tablets */
            }
        }
        ...
        /* Large desktop screens (optional for extra large displays) */
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/arjungtech-logo-removebg-preview.png" style="background-color: transparent;" class="logo-img">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="owl-carousel owl-banner">
                                <div class="item header-text">
                                    <h6>Welcome to Arjun G-Tech</h6>
                                    <h2>Build <em>your website</em> the best in <span>SEO</span></h2>
                                    <p>At Arjun G-Tech, we offer top-notch SEO services, web development, and deployment solutions to make your website stand out and rank high on search engines. We specialize in creating professional websites that drive
                                ...
                                <div class="item header-text">
                                    ...
                                    <p>We help you achieve your business goals with innovative digital marketing strategies, ensuring your website performs well and generates leads. From SEO to social media marketing, we've got you covered.</p>
                                    <div class="down-buttons">
                                        <div class="main-blue-button-hover">
                                ...
                                <div class="item header-text">
                                    <h6>Hosting & Deployment</h6>
                                    <h2>Deploy <em>your website</em> with the best <span>hosting solutions</span></h2>
                                    <p>At Arjun G-Tech, we provide reliable web hosting and deployment services. Whether you're looking to host a simple website or a complex application, we have the infrastructure and expertise to make sure your site runs
                                        smoothly 24/7.</p>
                                    <div class="down-buttons">
                                        <div class="main-blue-button-hover">
                                            <a href="#video">Watch Our Process</a>
                                        </div>
                                        <div class="call-button">
                                            <a href="tel:9624402490"><i class="fa fa-phone"></i> 9624402490</a>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-carousel owl-services">
                        <div class="item">
                            <h4>Web Development & Deployment</h4>
                            <div class="icon"><img src="assets/images/service-icon-01.png" alt=""></div>
                            <p>Our team builds and deploys robust websites and applications with scalable solutions to meet your business needs.</p>
                        </div>
                        <div class="item">
                            <h4>SEO & Digital Marketing</h4>
                            <div class="icon"><img src="assets/images/service-icon-02.png" alt=""></div>
                            <p>Boost your website’s ranking with our comprehensive SEO strategies and digital marketing expertise.</p>
                        </div>
                        <div class="item">
                            <h4>UI/UX Design & Development</h4>
                            <div class="icon"><img src="assets/images/service-icon-03.png" alt=""></div>
                            <p>We design intuitive and engaging user interfaces that provide exceptional user experiences across all devices.</p>
                        </div>
                        <div class="item">
                            <h4>Web Hosting Solutions</h4>
                            <div class="icon"><img src="assets/images/service-icon-04.png" alt=""></div>
                            <p>Reliable and secure hosting services tailored to your website’s needs, ensuring high performance and uptime.</p>
                        </div>
                        <div class="item">
                            <h4>Custom Application Development</h4>
                            <div class="icon"><img src="assets/images/service-icon-01.png" alt=""></div>
                            <p>We develop custom software solutions to help streamline your business operations and provide a seamless experience for your users.</p>
                        </div>
                        <div class="item">
                            <h4>Website Speed Optimization</h4>
                            <div class="icon"><img src="assets/images/service-icon-02.png" alt=""></div>
                            <p>We optimize your website’s speed to improve user experience and boost your search engine rankings.</p>
                        </div>
                        <div class="item">
                            <h4>Mobile Optimization</h4>
                            <div class="icon"><img src="assets/images/service-icon-03.png" alt=""></div>
                            <p>Ensure your website is fully optimized for mobile users, providing a responsive experience across all devices.</p>
                        </div>
                        <div class="item">
                            <h4>Content Strategy & Development</h4>
                            <div class="icon"><img src="assets/images/service-icon-04.png" alt=""></div>
                            <p>We help you create compelling content strategies that resonate with your audience and enhance brand engagement.</p>
                        </div>
                        <div class="item">
                            <h4>E-commerce Solutions</h4>
                            <div class="icon"><img src="assets/images/service-icon-01.png" alt=""></div>
                            <p>Build and deploy an online store with powerful e-commerce solutions that drive sales and provide a seamless shopping experience.</p>
                        </div>
                        <div class="item">
                            <h4>Cloud Solutions & Integration</h4>
                            <div class="icon"><img src="assets/images/service-icon-02.png" alt=""></div>
                            <p>We offer cloud-based solutions that scale with your business, from infrastructure setup to system integrations.</p>
                        </div>
                        <div class="item">
                            <h4>Digital Strategy Consulting</h4>
                            <div class="icon"><img src="assets/images/service-icon-03.png" alt=""></div>
                            <p>Our expert consultants provide guidance on digital transformation, helping you define and execute a strategy that drives growth.</p>
                        </div>
                        <div class="item">
                            <h4>Web Security & Maintenance</h4>
                            <div class="icon"><img src="assets/images/service-icon-04.png" alt=""></div>
                            <p>We offer ongoing website security monitoring and maintenance to ensure your website remains safe and up-to-date.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="section-heading">
                        ...
                        <p>At Arjun G-Tech, we combine cutting-edge SEO strategies with efficient project management tools to ensure your website grows and thrives. Our team helps you optimize your site for better performance, higher rankings, and measurable
                            results in your digital journey.</p>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="fact-item">
                                    <div class="count-area-content">
                                        ...
                                        <p>We have successfully completed over 320 SEO projects, helping businesses improve their online visibility and rankings.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="fact-item">
                                    <div class="count-area-content">
                                        ...
                                        <div class="count-title">Websites Developed</div>
                                        <p>Our team has developed over 640 websites, providing custom solutions that cater to various industries and business needs.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="fact-item">
                                    <div class="count-area-content">
                                        ...
                                        <p>With 120 satisfied clients, Arjun G-Tech continues to deliver exceptional results and outstanding customer service to businesses worldwide.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-0">
                    ...
                    <div class="bg-light rounded">
                        ...
                        <div class="p-5 pt-0">
                            <h1 class="display-5 mb-3">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rs</small>9999.00<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Website</small>
                            </h1>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <span>Domain Purchase</span><i class="fa fa-times text-danger pt-1"></i>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Website Hosting</span><i class="fa fa-times text-danger pt-1"></i>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Website SEO</span><i class="fa fa-times text-danger pt-1"></i>
                            </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                        ...
                        <div class="p-5 pt-0">
                            <h1 class="display-5 mb-3">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rs</small>12999.00<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Website</small>
                            </h1>
                            <div class="d-flex justify-content-between mb-3">
                                <span>HTML5 & CSS3</span><i class="fa fa-check text-primary pt-1"></i>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <span>Domain Purchase</span><i class="fa fa-check text-primary pt-1"></i>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Website Hosting</span><i class="fa fa-times text-danger pt-1"></i>
                            </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="bg-light rounded">
                        ...
                        <div class="p-5 pt-0">
                            <h1 class="display-5 mb-3"> <small class="align-top" style="font-size: 22px; line-height: 45px;">Rs</small>18999.00<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Website</small></h1>
                            <div class="d-flex justify-content-between mb-3">
                                <span>HTML5 & CSS3</span><i class="fa fa-check text-primary pt-1"></i>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <span>Website Hosting</span><i class="fa fa-check text-primary pt-1"></i>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Website SEO</span><i class="fa fa-check text-primary pt-1"></i>
                            </div>
                            <a href="" class="btn btn-primary py-2 px-4 mt-4">Order Now</a>
                        </div>
                    </div>
